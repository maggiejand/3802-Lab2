...
% Steady state analytical slope
 M_exp= [18.4664; 4.8774; 4.312; 0.0937; 0.4687];

% Experimental initial slope from Task 2
H_analytical = [286.6; 150.5; 105.6; 79.2; 55.4];

% Initial temperature intercept
T0 = [15.107440476190478;
      16.780357142857130;
      16.541666666666664;
      17.239880952380950;
      17];
